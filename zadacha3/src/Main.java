...
public class Main {
    public static void main(String[] args) {
        ...
        for (NumPari pairVotes : pairVotesList) {
    ...
    static class NumPari {
        private final int pairNumber;
        private final int vote;

        public NumPari(int pairNumber, int vote) {
    ...
    static void bubbleSort(List<NumPari> list) {
        ...
        do {
            ...
            for (int i = 0; i < n - 1; i++) { // Проходим по списку
                ...
                if (list.get(i).getVote() < list.get(i + 1).getVote()) {
                    ...
                    NumPari temp = list.get(i); // Сохраняем текущий элемент
